...
function iniciarModuloProveedores() {
    ...
    if (moduloProveedores === null) {
        console.warn(
            "No se encontró el elemento modulo-proveedores."
        );
            ...
            <form id="formulario-proveedores">
                <div class="grupo-formulario">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Ejemplo: Tecnología CR"
                        required
                    >
                </div>
                ...
                <div class="grupo-formulario">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Ejemplo: Carlos Vargas"
                        required
                    >
                </div>

                <div class="grupo-formulario">
                    <label for="proveedor-correo">
                        Correo electrónico
                    </label>
                    ...
                    <input
                        id="proveedor-correo"
                        type="email"
                        placeholder="Ejemplo: ventas@tecnologiacr.com"
                        required
                    >
                </div>
...
function prepararEdicionProveedor(idProveedor) {
    ...
    mostrarMensajeProveedor(
        "Editando proveedor seleccionado.",
        "informacion"
    );
}
